        ...
        <div class="col-8 col-lg-8">
            ...
            <div class="card">
                <div class="card-body p-4">
                    ...
                    <h5 class="mb-4">Edit Video</h5>
                    <form id="editVideoForm" action="{{ route('admin.updatevideo') }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row mb-3">
                            <div class="col-sm-12">
                                ...
                                <div id="drop-area">
                                    ...
                                    <input type="file" id="blogvideo" name="video" class="file-input"
                                        accept="video/*" />
                                    ...
                                    <div style="margin-top:10px; display:block;" id="videoAction">
                                        <button type="button" id="replaceVideo"
                                            class="btn btn-warning btn-sm">Replace</button>
                        ...
                        <div class="row mb-3">
                            <div class="col-sm-12">
                                ...
                                <input type="text" class="form-control" name="videoname" value="{{ $video->name }}"
                                    id="blogname" placeholder="Add Blog Name" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-sm-12">
                                ...
                                <div class="selected-categories" id="selectedCategories"
                                    ...
                                    @foreach ($videoCategories as $categoryId)
                                    @php
...
$(document).ready(function() {
    ...
    function addHiddenInput(type, id) {
        ...
        $(`#editVideoForm`).append(`<input type="hidden" name="${type}[]" value="${id}">`);
    }
    ...
    $('#updateBtn').on('click', function(e) {
        ...
        if ($('#editVideoForm')[0].checkValidity() === false) {
            e.stopPropagation();
            $('#editVideoForm').find(':input[required]').each(function() {
