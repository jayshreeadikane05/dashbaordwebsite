                            ...
                            <div class="col-sm-12">
                                ...
                                <div id="drop-area">
                                    ...
                                    <div style="margin-top:10px; display:none;" id="imageAction">
                                        <button type="button" id="replaceImage"
                ...
                <div class="card-body p-4">
                    <div class="row">
                        ...
                        @endforeach
                            ...
                            <hr>
                            <div class="d-flex justify-content-center">
    <button type="button" class="btn " data-bs-toggle="modal" data-bs-target="#addTagModal"><img src="{{ asset('assets/images/Group.svg') }}" class="img-fluid" alt=""> Add Tag</button>
</div>
...
function addHiddenInput(type, id) {
    $(`#addBlogForm`).append(`<input type="hidden" name="${type}[]" value="${id}">`);
}
...
$('.tag-label').on('touchstart', drag);
    ...
    $('#submitBtn').on('click', function(e) {
        ...
        if ($('#addBlogForm')[0].checkValidity() === false) {
            e.stopPropagation();

            $('#addBlogForm').find(':input[required]').each(function() {
            ...
            if (file) {
                console.log('File being uploaded:', file.name); // Just to debug
            } else {
